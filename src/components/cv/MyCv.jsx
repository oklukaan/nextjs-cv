...
>>>>>>> parent of 02ecf31 (changes last 15.01)
const MyCv = () => {
                                                                        ...
                                                                        <div className="col-md-1 bg1 timeline-space full-height hidden-sm hidden-xs" />
                                                                         ...
                                                                         <h2 className="section-title">Projelerim</h2></div>
                                                                            ...
                                                                            <div className="line row"> 
                                                                             ...
                                                                             <div className="col-md-8 content-wrap bg1"> 
                                                                             <div className="line-content"> 
                                                                              <h3 className="section-item-title-1">WEB TEKNOLOJİLERİ / SCRIPTING DİLLERİ</h3>   
...
=======
                                                            <div className="col-md-1 bg1 timeline-space full-height hidden-sm hidden-xs" /></div>   <div className="line row">  <div className="col-md-1 bg1 timeline-space full-height hidden-sm hidden-xs" /> <div className="col-md-2 timeline-progress hidden-sm hidden-xs full-height timeline-work " />   <div className="col-md-8 content-wrap bg1"> <div className="line-content line-content-education">  <h3 className="section-item-title-1">Arca Software</h3>   <h4 className="job"><i className="fa fa-flag" /> Stajyer - Yazılım Geliştirici- <span className="job-date">Ocak 2021 - Haziran 2021</span></h4>   <div className="job-description"> <p>Arca Yazılım Bünyesinde:</p> <ul className="job-list"> <li>C# ,ASP .net</li> <li> Online Eğitim Sistemi oluşturulması</li> <li>Trend takip sisteminin ve altyapısının oluşturulması</li> <li>Yönetim panelinin güncellenmesi</li> </ul> </div></div> </div>   <div className="col-md-1 bg1 timeline-space full-height hidden-sm hidden-xs" /></div></section>   <section className="timeline work-experience" id="projects-and-others">  <div className="line row timeline-margin"> <div className="content-wrap"> <div className="col-md-1 bg1 timeline-space full-height hidden-sm hidden-xs" /> <div className="col-md-2 timeline-progress hidden-sm hidden-xs full-height" /> <div className="col-md-9 bg1 full-height" /> </div> </div>   <div className="line row">  <div className="col-md-1 bg1 timeline-space full-height hidden-sm hidden-xs" /> <div className="col-md-2 timeline-progress hidden-sm hidden-xs timeline-title full-height" />   <div className="col-md-8 content-wrap bg1">  <h2 className="section-title">Projelerim</h2></div>   <div className="col-md-1 bg1 timeline-space full-height hidden-sm hidden-xs" /></div>   <div className="line row">  <div className="col-md-1 bg1 timeline-space full-height hidden-sm hidden-xs" /> <div className="col-md-2 timeline-progress hidden-sm hidden-xs full-height timeline-work " />   <div className="col-md-8 content-wrap bg1"> <div className="line-content line-content-education"> <div className="job-description"> <ul className="neler-yaptim"> <li><strong>1999</strong> : Henüz 8 yaşındayken bilgisayar operatörlüğü belgemi aldım.</li> <li><strong>2006</strong> : 100 saatlik web tasarım/programlama eğitimi aldım.</li> <li><strong>2009</strong> : TÜBİTAK proje yarışmasına katıldığım bilgisayar projesi ile AFLİVA birincilik ödülü aldım.</li> <li><strong>2010</strong> : ODTÜ’de düzenlenen UPEM’e katıldım, yarışmada Ege Üniversitesini temsil ettim.</li> <li><strong>2010 – 2011</strong> : Ege Üniversitesi Bilgisayar Mühendisliği bünyesinde Photoshop eğitimi verdim.</li> <li><strong>2011</strong> : TEGV’den gelen katılımcılara internet ve web teknolojileri eğitimi verdim.</li> <li><strong>2012</strong> : OBSS’nin düzenlediği Ege Üniversitesi Java Roadshow yarışmasında birincisi oldum.</li> </ul> </div></div> </div>   <div className="col-md-1 bg1 timeline-space full-height hidden-sm hidden-xs" /></div></section>   <section className="timeline skills" id="skills">  <div className="line row timeline-margin"> <div className="content-wrap"> <div className="col-md-1 bg1 timeline-space full-height hidden-sm hidden-xs" /> <div className="col-md-2 timeline-progress hidden-sm hidden-xs full-height" /> <div className="col-md-9 bg1 full-height" /> </div> </div>   <div className="line row">  <div className="col-md-1 bg1 timeline-space full-height hidden-sm hidden-xs" /> <div className="col-md-2 timeline-progress hidden-sm hidden-xs timeline-title full-height" />   <div className="col-md-8 content-wrap bg1">  <h2 className="section-title">TEKNİK BECERİLER</h2></div>   <div className="col-md-1 bg1 timeline-space full-height hidden-sm hidden-xs" /></div>   <div className="line row">  <div className="col-md-1 bg1 timeline-space full-height hidden-sm hidden-xs" /> <div className="col-md-2 timeline-progress hidden-sm hidden-xs full-height timeline-point " />   <div className="col-md-8 content-wrap bg1"> <div className="line-content">  <h3 className="section-item-title-1">PROGRAMLAMA DİLLER</h3>   <ul className="skills-list">  <li> <div className="progress"> <div className="progress-bar" role="progressbar" data-percent="80%" style={{ width: '80%' }}> <span className="sr-only">80% Complete</span> </div> <span className="progress-type">Java</span> <span className="progress-completed">80%</span> </div> <ul className="skill-usage"> <li>Java tabanlı web uygulamaları, (Spring, Play!, JSF desteği ile)</li> <li>SOAP, RESTful web servis tasarımı,</li> <li>GWT + Swing ile masaüstü uygulamaları,</li> <li>Pek çok tasarım deseni kullanarak katmanlı mimari tasarımı,</li> <li>Asenkron multithread uygulamalar.</li> <li>Maven, ANT, Grails</li> </ul> </li>   <li> <div className="progress"> <div className="progress-bar progress-bar-2" role="progressbar" data-percent="70%" style={{ width: '70%' }}> <span className="sr-only">70% Complete</span> </div> <span className="progress-type">C#.Net</span> <span className="progress-completed">70%</span> </div> <ul className="skill-usage"> <li>Windows Forms ile masaüstü uygulamaları,</li> <li>TCP/IP, Soket uygulamaları,</li> <li>Entity Framework ve web servisler kullanılarak otomasyon sistemlerinin hazırlanması.</li> </ul> </li>   <li> <div className="progress" title="İşte eğlence burada başlıyor!"> <div className="progress-bar progress-bar-3" role="progressbar" data-percent="40%" style={{ width: '40%' }}> <span className="sr-only">40% Complete</span> </div> <span className="progress-type">Scala</span> <span className="progress-completed">40%</span> </div> <ul className="skill-usage"> <li>Play! Framework backend servisleri ve ön yüz templeteleri oluşturulması.</li> </ul> </li>   <li> <div className="progress"> <div className="progress-bar" role="progressbar" data-percent="10%" style={{ width: '17%' }}> <span className="sr-only">10% Complete</span> </div> <span className="progress-type">Go (Golang)</span> <span className="progress-completed">10%</span> </div> <ul className="skill-usage"> <li>Hobi amaçlı küçük projeler.</li> </ul> </li></ul></div> </div>   <div className="col-md-1 bg1 timeline-space full-height hidden-sm hidden-xs" /></div>   <div className="line row">  <div className="col-md-1 bg1 timeline-space full-height hidden-sm hidden-xs" /> <div className="col-md-2 timeline-progress hidden-sm hidden-xs full-height timeline-point " />   <div className="col-md-8 content-wrap bg1"> <div className="line-content">  <h3 className="section-item-title-1">WEB TEKNOLOJİLERİ / SCRIPTING DİLLERİ</h3>   <ul className="skills-list">  <li> <div className="progress"> <div className="progress-bar" data-percent="85%" role="progressbar" style={{ width: '85%' }}> <span className="sr-only">85% Complete</span> </div> <span className="progress-type">HTML / CSS</span> <span className="progress-completed">85%</span> </div> <ul className="skill-usage"> <li>Div tabanlı responsive tasarımlar,</li> <li>Bootstrap, LESS gibi güncel araç tecrübesi,</li> <li>Kullanıcı deneyimi bilgisi.</li> </ul> </li>   <li> <div className="progress"> <div className="progress-bar progress-bar-2" data-percent="80%" role="progressbar" style={{ width: '80%' }}> <span className="sr-only">80% Complete</span> </div> <span className="progress-type">JavaScript</span> <span className="progress-completed">80%</span> </div> <ul className="skill-usage"> <li>Scope kavramına hakimlik, object oriented tasarımlar,</li> <li>jQuery ile DOM yönetimi, dinamik tasarımlar,</li> <li>AngularJS MVW kütüphanesi kullanımı,</li> <li>NodeJS ile küçük uğraşılar.</li> </ul> </li>   <li> <div className="progress"> <div className="progress-bar progress-bar-3" data-percent="70%" role="progressbar" style={{ width: '70%' }}> <span className="sr-only">70% Complete</span> </div> <span className="progress-type">PHP</span> <span className="progress-completed">70%</span> </div> <ul className="skill-usage"> <li>OO Php uygulamaları,</li> <li>Wordpress, Drupal, Joomla gibi CMS&apos;ler ve PhpBB,SMF,vBulletin gibi forum uygular hakkında plugin geliştirebilecek seviyede bilgi sahipliği.</li> <li>Admin paneli uygulamaları geliştirilmesi,</li> <li>Data toplama amaçlı scriptler.</li> </ul> </li></ul></div> </div>   <div className="col-md-1 bg1 timeline-space full-height hidden-sm hidden-xs" /></div>   <div className="line row">  <div className="col-md-1 bg1 timeline-space full-height hidden-sm hidden-xs" /> <div className="col-md-2 timeline-progress hidden-sm hidden-xs full-height timeline-point " />   <div className="col-md-8 content-wrap bg1"> <div className="line-content">  <h3 className="section-item-title-1">VERİTABANI YÖNETİMİ / KULLANIMI</h3>   <ul className="skills-list">  <li> <div className="progress"> <div className="progress-bar progress-bar-3" data-percent="80%" role="progressbar" style={{ width: '80%' }}> <span className="sr-only">80% Complete</span> </div> <span className="progress-type">ORACLE</span> <span className="progress-completed">80%</span> </div> <ul className="skill-usage"> <li>Yapı Kredi NUVO uygulamasının veri katmanının tasarlanması,</li> <li>Veri yapıları, sınırlamalar hakkında tacrübe sahipliği,</li> <li>PL/SQL diline hakimlik (Paket yapısı, procedure çağrımları, transaction yönetimi),</li> <li>TOAD, PLSQLDeveloper kullanımı konusunda tecrübe sahipliği.</li> <li>Şema ve user yetkilendirmeleri hakkında bilgi sahibi,</li> <li>Database link hakkında bilgi sahibi,</li> </ul> </li>   <li> <div className="progress"> <div className="progress-bar progress-bar-2" data-percent="60%" role="progressbar" style={{ width: '60%' }}>
